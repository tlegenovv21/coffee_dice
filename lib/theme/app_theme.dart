...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      headlineMedium: TextStyle(color: Color(0xFF3E2723), fontWeight: FontWeight.w900),
    ),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleLarge: TextStyle(color: Color(0xFFEFEBE9), fontWeight: FontWeight.bold),
      headlineMedium: TextStyle(color: Color(0xFFEFEBE9), fontWeight: FontWeight.w900),
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      floatingLabelBehavior: FloatingLabelBehavior.always,
      labelStyle: const TextStyle(color: Color(0xFFBCAAA4), fontWeight: FontWeight.bold),
